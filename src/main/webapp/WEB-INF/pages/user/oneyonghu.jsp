				...
				<form id="form_search">
					<div class="form-row align-items-center">
						<div class="col-auto my-1">
							<input type="text" class="form-control" name="buyerName" placeholder="用户账号">
						
						</div>
						<div class="col-auto my-1">
							<input type="text" class="form-control" name="buyerCode" placeholder="用户名称">
						</div>
						<div class="col-auto my-1">
							<input type="text" class="form-control" name="buyerPhone" placeholder="用户手机">
						</div>
						<div class="col-auto my-1">
			...
			<form id="form_role_add_edit">
				<div class="modal-body">
					<div class="form-group row">
						...
						<div class="col-sm-7">
							<input type="text" class="form-control validate[required]" id="buyerName" name="buyerName">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">用户账号</label>
						<div class="col-sm-7">
							<input type="text" class="form-control validate[required]" name="buyerCode" id="buyerCode">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">用户手机</label>
						<div class="col-sm-7">
							<input type="text" class="form-control validate[required]" name="buyerPhone" id="buyerPhone"></textarea>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">用户密码</label>
						<div class="col-sm-7">
							<input type="text" class="form-control validate[required]" name="buyerPass" id="buyerPass"></textarea>
						</div>
					</div>
