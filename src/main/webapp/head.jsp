				...
				<div class="header-area-style1" id="sticker">
					<div class="header-top">
						<div class="header-top-inner-top">
							<div class="container">
								<div class="row">
									<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="width:670px;">
										<div class="header-contact">
											<ul>
												<li><i class="fa fa-phone" aria-hidden="true"></i><a href="https://www.bilibili.com/"> + 134 6534 3058</a></li>
												<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="https://user.qzone.qq.com/2725595128?source=panelstar"> 2725595128@qq.com</a></li>
											</ul>
										</div>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="width:500px" >
										<div class="account-wishlist">
											<ul>
											    <li><a href="goingindex"><i class="fa fa-heart-o" aria-hidden="true"></i>退出登录</a></li>
												<li title="亲！你已经登录了!" ><a href="login"><i class="fa fa-lock" aria-hidden="true"></i> 您已登录</a></li>
												<li><a href="wishlist"><i class="fa fa-heart-o" aria-hidden="true"></i> 心愿单</a></li>
												<li><a href="goingUser"><i class="fa fa-usd" aria-hidden="true"></i> 个人中心</a></li>
											</ul>
										</div>
									</div>
								</div>
										...
										<nav>
											<ul>
												<li class="active"><a href="#">主页</a>
													<ul>
														<li><a class="active" href="index.html">主页 1</a></li>
														<li><a href="index2.html">主页 2</a></li>
														<li><a href="index3.html">主页 3</a></li>
														<li><a href="index4.html">主页 4</a></li>
													</ul>	
												</li>
												...
												<li><a href="#">页数</a>
													<ul class="mega-menu-area">
														<li>
															...
															<a href="index2.html">主页 2</a>
															<a href="index3.html">主页 3</a>
															<a href="index4.html">主页 4</a>
														</li>	
														<li>
															<a href="about.html">关于我们 </a>
															<a href="blog.html">博客</a>
															<a href="single-blog.html">单博客</a>
															<a href="portfolio1.html">投资组合 1</a>
														</li>	
														<li>
															<a href="portfolio2.html">Portfolio 2</a>
															<a href="wishlist.html">愿望清单</a>
															<a href="shop1.html">商城 1</a>
															<a href="shop2.html">商城 2</a>
														</li>
														<li>
															<a href="shop3.html">商城 3</a>
															<a href="shop4.html">商城 4</a>
															<a href="shop5.html">商城 5</a>
															<a href="shop6.html">商城 6</a>
														</li>
														<li>
															<a href="shop7.html">商城 7</a>
															<a href="product-details1.html">产品详情1</a>
															<a href="product-details2.html">产品详情2</a>
															<a href="login-registration.html">登录/注册</a>
														</li>
														<li>
															<a href="cart.html">Cart购物车</a>
															<a href="check-out.html">结账</a>
											...
											<nav id="dropdown">
												<ul>
													...
													<li><a href="#">博客</a>
														<ul>
															<li><a href="blog.html">博客</a></li>
															<li><a href="single-blog.html">登录 Blog</a></li>
														</ul>	
													</li>
													<li><a href="#">文件夹</a>
														<ul>
															<li><a href="portfolio1.html">文件夹 1</a></li>
															<li><a href="portfolio2.html">文件夹 2</a></li>
														</ul>	
													</li>
													<li><a href="#">商城</a>
														<ul>
															<li><a href="shop1.html">商城 1</a></li>
															<li><a href="shop2.html">商城 2</a></li>
															<li><a href="shop3.html">商城 3</a></li>
															<li><a href="shop4.html">商城 4</a></li>
															<li><a href="shop5.html">商城 5</a></li>
															<li><a href="shop6.html">商城 6</a></li>
															<li><a href="shop7.html">商城 7</a></li>
															<li><a href="product-details1.html">商店详情 1</a></li>
															<li><a href="product-details2.html">商店详情 2</a></li>
														</ul>	
													</li>
													<li><a href="#">多页码</a>
														<ul>
															<li><a href="login-registration.html">登录/注册</a></li>
															<li><a href="cart.html">购物车</a></li>
															<li><a href="wishlist.html">心愿单</a></li>
															<li><a href="check-out.html">结账</a></li>
